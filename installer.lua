...
local FILES = {
    ...
    {url = "startup-new.lua", path = INSTALL_DIR .. "/startup-new.lua"},
    -- config.lua is NOT included - it's generated by setup wizard
    {url = "me.lua", path = INSTALL_DIR .. "/me.lua"},
    {url = "altar.lua", path = INSTALL_DIR .. "/altar.lua"},
    {url = "altar-new.lua", path = INSTALL_DIR .. "/altar-new.lua"},
    {url = "gui.lua", path = INSTALL_DIR .. "/gui.lua"},
    {url = "gui-new.lua", path = INSTALL_DIR .. "/gui-new.lua"},
...
shell.run("/mystical-automation/debug.lua")]]
    ...
    {
        name = "mystical-test",
        content = [[-- MysticalAgriculture Craft Test
shell.run("/mystical-automation/altar-craft-test.lua")]]
    },
    {
        name = "mystical-new",
        content = [[-- MysticalAgriculture Automation (Rewritten)
shell.run("/mystical-automation/startup-new.lua")]]
    },
}
